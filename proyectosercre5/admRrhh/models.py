...
class Personal(models.Model):
  ...
  tipoLic_perl=models.CharField(max_length=10, default="S/n", verbose_name='Tipo de Licencia')
  fechVenlic_perl=models.CharField(max_length=10,default="S/n", null=True,blank=True,verbose_name='Fecha vencimiento de licencia')
